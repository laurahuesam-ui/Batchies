...
try{if(typeof bindWarehouseUi==='function')bindWarehouseUi()}catch(err){console.error('Lager UI:',err)};try{if(typeof bindSalesUi==='function')bindSalesUi()}catch(err){console.error('Verkaufs UI:',err)};
