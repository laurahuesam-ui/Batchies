const PRODUCT_COLORS=[
  ...
  {name:'Dunkelbraun',hex:'#4b2b1a'},
  {name:'Khaki',hex:'#8b8b55'},
  {name:'Olivgrün',hex:'#7b7a3d'},
  {name:'Rot',hex:'#d64545'},
  {name:'Koralle',hex:'#f26f63'},
  {name:'Rosa',hex:'#f2a7b8'},
  {name:'Altrosa',hex:'#c98696'},
  {name:'Pink',hex:'#e83e8c'},
  {name:'Magenta',hex:'#c82f7a'},
  {name:'Bordeaux',hex:'#7b1f3a'},
  {name:'Orange',hex:'#ef8b2c'},
  {name:'Apricot',hex:'#f5b27c'},
  {name:'Pfirsich',hex:'#f7a987'},
  {name:'Gelb',hex:'#e5c83f'},
  {name:'Senfgelb',hex:'#c7a32b'},
  {name:'Hellgrün',hex:'#9bd38c'},
  {name:'Mint',hex:'#a8dfc1'},
  {name:'Grün',hex:'#4f9b5f'},
  {name:'Dunkelgrün',hex:'#24513b'},
  {name:'Pfaugrün',hex:'#007f73'},
  {name:'Hellblau',hex:'#8fc8e8'},
  {name:'Blau',hex:'#3978c5'},
  {name:'Dunkelblau',hex:'#1f3f73'},
  {name:'Türkis',hex:'#35b7b1'},
  {name:'Petrol',hex:'#0b6b73'},
  {name:'Flieder',hex:'#c2a2da'},
  {name:'Lavendel',hex:'#aa8bd2'},
