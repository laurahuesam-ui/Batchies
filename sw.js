const CACHE='batchies-v1.4';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./js/config.js','./js/core.js','./js/categories.js','./js/pricing.js','./js/products.js','./js/batches.js','./js/exports.js','./js/app.js'];
